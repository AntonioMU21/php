...
<body>
    <div class="main-panel">
        ...
        echo "<form action='CrearCarpeta.php' method='POST'>";
        echo "<tr><td><input type='text' name='nombre_carpeta' placeholder='Nombre de la nueva carpeta'>
<input type='submit' value='Crear Carpeta'></td></tr></form>";
        ...
        while ($elemento = readdir($dir)) {
            ...
            if ($elemento != "." && $elemento != "..") {
                // Lo que se lista ya
                //declarar variables, no se porque si no lo haces no funciona
                $foto = "carpeta.png";
                ...
                if (filetype($ruta_completa) == "file") {
                    $foto = "archivo.png";
                    $fila = "<tr><td>" . $elemento . "<td><img src='$foto' width='40'></td><td><a href='info.php?f=$elemento'><img src=info.png width='40'></a></td><td><a href='borrar.php?f=$elemento'><img src='borrar2.png' width='40'></a></td>" . "</td></tr>";
                } else {
                    $foto = "carpeta.png";
                    $fila = "<tr><td>" . $elemento . "<img src='$foto' width='40'></td><td><a href='vercarpeta.php?d=$elemento'>Ver carpeta</a>" . "</td></tr>";
                }
